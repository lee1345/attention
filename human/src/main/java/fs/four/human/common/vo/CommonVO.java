...
public class CommonVO {
    ...
    public String getE_created_date() {
        return e_created_date;
    }

    public void setE_created_date(String e_created_date) {
        this.e_created_date = e_created_date;
    }

    public String getE_updated_date() {
        return e_updated_date;
    }

    public void setE_updated_date(String e_updated_date) {
